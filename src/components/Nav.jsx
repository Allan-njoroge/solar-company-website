  ...
  return (
    <div className="shadow-md w-full top-0 left-0 text-gray-300 border-b border-green-300">
      <div className="md:flex py-4 md:px-10 px-5 items-center justify-between max-w-[1440px] mx-auto">
        ...
        {/*   Navbar links    */}
        <ul className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static md:bg-transparent bg-green-300 md:z-auto z-[-1] left-0 w-[50%] md:w-auto h-screen md:h-16 md:pl-0 pl-9 transition-all ease-in duration-700 ${menuOpen ? 'top-16 opacity-100' : 'left-[-490px] opacity-0 md:opacity-100'}`}>
          {
            Links.map((Links) => (
